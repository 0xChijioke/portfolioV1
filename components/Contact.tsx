  ...
  return (
    <motion.div
        ...
        transition={{ duration: 1.5 }}
          className="h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly max-w-screen lg:space-y-0 mx-auto items-center">
