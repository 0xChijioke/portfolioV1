...
function Experience({}: Props) {
  return (
    <motion.div 
      ...
      <div className="w-full flex items-center mt-20 space-x-5 overflow-x-scroll p-10 scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A] snap-x snap-center snap-mandatory">
        <ExperienceCard />
        <ExperienceCard />
        <ExperienceCard />
      </div>
