  ...
  return (
    <div className='group relative flex cursor-pointer'>
        <motion.img 
            ...
            src={skill?.imageSrc}
            alt={skill?.name}
            className='rounded-full border border-gray-500 object-contain w-10 h-10 lg:w-20 lg:h-20 filter group-hover:grayscale transition durantion-300 ease-in-out'
        />
